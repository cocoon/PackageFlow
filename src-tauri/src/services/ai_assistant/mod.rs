...
// - Session context for precise project/workflow targeting (025)
...
pub use prompt_builder::{SystemPromptBuilder, build_system_prompt_with_tools, build_system_prompt_with_session_context};
...
pub use session_context::{SessionContextBuilder, build_simple_session_context};

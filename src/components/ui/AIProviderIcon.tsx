/**
 * AI Provider Icon Component
 * Displays official brand icons for AI service providers
 */
...
// Provider-specific color schemes for UI components
export const AI_PROVIDER_COLORS: Record<AIProvider, {
  selected: string;
  unselected: string;
  iconBg: string;
}> = {
  ollama: {
    selected: 'bg-gray-500/10 border-gray-400/50 text-foreground',
    unselected: 'hover:bg-gray-500/5 hover:border-gray-400/30',
    iconBg: 'bg-gray-900 text-white dark:bg-gray-800',
  },
  lm_studio: {
    selected: 'bg-indigo-500/15 border-indigo-400/50 text-indigo-700 dark:text-indigo-300',
    unselected: 'hover:bg-indigo-500/5 hover:border-indigo-400/30',
  ...
  anthropic: {
    selected: 'bg-[#D4A27F]/15 border-[#D4A27F]/50 text-[#8B5A2B] dark:text-[#D4A27F]',
    unselected: 'hover:bg-[#D4A27F]/5 hover:border-[#D4A27F]/30',
    iconBg: 'bg-[#D4A27F] text-white',
  },
  gemini: {
    selected: 'bg-blue-500/15 border-blue-400/50 text-blue-700 dark:text-blue-300',
    unselected: 'hover:bg-blue-500/5 hover:border-blue-400/30',
...
export const AIProviderIcon: React.FC<AIProviderIconProps> = ({ provider, className, size = 20 }) => {
  const iconProps = { width: size, height: size, className };

  switch (provider) {
    case 'openai':
      // OpenAI logo - official icon
      return (
    ...
    case 'gemini':
      // Google Gemini logo - official sparkle shape with gradient
      return (
    ...
    case 'ollama':
      // Ollama logo - official llama icon
      return (
        <svg {...iconProps} viewBox="0 0 24 24" fill="currentColor" fillRule="evenodd">
...
// Helper function to get provider color scheme
export function getProviderColorScheme(providerId: AIProvider) {
  return AI_PROVIDER_COLORS[providerId] || {
    selected: 'bg-primary/15 border-primary/50 text-primary',
    unselected: 'hover:bg-primary/5 hover:border-primary/30',
